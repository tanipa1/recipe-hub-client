            ...
            <footer className="footer p-10 bg-black text-white">
                <div>
                    <div className='flex gap-1 items-center justify-center'>
                        ...
                        <div>
                            <Link to='/' className=" font-bold px-0 normal-case text-base lg:text-xl">Recipe<span className='text-[#f8cf5f] lg:text-2xl font-extrabold'>HUB</span></Link>
                            <p className='py-0 my-0 text-base-200 lg:text-xs text-xs'><small>Recipe Recommendation <br></br>& Sharing Platform</small></p>
                        </div>
                    </div>
                    <div className="ml-20 lg:ml-24 grid grid-flow-col gap-4">
                ...
                <div>
                    ...
                    <div className="form-control w-80">
                        ...
                        <div className="relative">
                            ...
                            <button className="btn login absolute top-0 right-0 rounded-l-none">Subscribe</button>
                        </div>
                    </div>
                </div>
            </footer>
