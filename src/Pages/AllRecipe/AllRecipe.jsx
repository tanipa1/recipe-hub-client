...
const AllRecipe = () => {
    ...
    return (
        <div>
            {/* banner */}
            <div className="hero p-7 lg:mb-10 mb-3" style={{ backgroundImage: 'url(https://img.freepik.com/premium-photo/image-portrays-passover-greeting-card-idea-featuring-matzah-nuts-tulip-flowers-arranged_176841-9785.jpg?w=1060)' }}>
            ...
            {/* Search */}
            <div className="lg:mx-20 mx-3 mb-3 flex lg:justify-end justify-center relative">
                <input type="text" placeholder="Search Recipe By Name " className="input w-full input-bordered" value={query} onChange={handleSearch} />
