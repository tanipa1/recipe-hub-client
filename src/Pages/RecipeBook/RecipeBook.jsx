...
const RecipeBook = () => {
    return (
        <div className='my-10 lg:mx-10 mx-6 gap-8 lg:gap-0 grid lg:grid-cols-4 grid-cols-2'>
            {/* Book Details */}
            <div className='grid justify-center'>
                <a href={dudeKitchenBook} target='_blank'>
                    <img class="lg:w-48" alt="open pdf" src={dudeKitchen} />
                </a>
                <div className='mt-2 '>
                    <h1 className='font-bold font-serif lg:text-lg'>Dudes' Kitchen</h1>
            ...
            <div className='grid justify-center'>
                ...
                <div className='mt-2 '>
                    <h1 className='font-bold font-serif lg:text-lg'>Cook Italian</h1>
            ...
            <div className='grid justify-center'>
                ...
                <div className='mt-2 '>
                    <h1 className='font-bold font-serif lg:text-lg'>Wild Delights</h1>
            ...
            <div className='grid justify-center'>
                ...
                <div className='mt-2 '>
                    <h1 className='font-bold font-serif lg:text-lg'>300 Recipes for Chicken</h1>
