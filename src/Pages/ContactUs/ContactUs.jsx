...
const ContactUs = () => {
    ...
    return (
        <div className='hero' style={{backgroundImage: 'url(https://img.freepik.com/free-photo/top-view-food-ingredients-with-notebook-pumpkin_23-2148834716.jpg?w=360&t=st=1693063365~exp=1693063965~hmac=5aa9e766172cc0a39a3a69d8bdccbdfe8927e323a708c24ebc717b8948943650)'}}>
            ...
            <div className="flex justify-center items-center lg:px-24 lg:gap-20 gap-8 flex-col ">
                <div className="text-white text-center lg:text-left">
                    <h1 className="lg:text-5xl text-xl mt-5 text-white font-bold">Get In Touch!</h1>
                ...
                {/* CEO */}
            <div className="grid justify-center lg:px-20 ">
                <div className=" text-white gap-8 lg:gap-32 items-center grid lg:grid-cols-2 justify-center lg:justify-around">
                    <img src={Tahira} className="w-1/2 lg:w-full animate__animated animate__slideInDown max-w-sm rounded-lg lg:shadow-2xl mx-auto" />
                    <div className='grid justify-center text-center lg:text-start'>
                        <h1 className="lg:text-3xl text-xl font-bold font-mono">Tahira Tabassum Yeana</h1>
                        <p className="text-sm pb-4 font-bold">CEO, Recipe Hub</p>
            ...
            <div className='lg:px-44 px-10 mt-16 mb-10 text-white'>
                ...
                <p className='text-justify lg:ml-20 ml-0 font-serif font-bold'>
